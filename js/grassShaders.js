...
"       comb.x -= 2.0 * cTime;",
"",     //If the grass reaches the end of the plane, reposition it
"       if(comb.x < -1000.0)",
"       {",        
"           comb.x += 2000.0;",
"",
...
" vec3 ltGreen = vec3( 0.4, 0.8, 0.4);",
" vec3 dkGreen = vec3(0.12, 0.38, 0.12);",
" gl_FragColor.rgb = mix(dkGreen, ltGreen, vUv.y);",
" #ifdef USE_FOG",
